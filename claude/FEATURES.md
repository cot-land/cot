...
| # | Feature | CIR Op(s) | ac Syntax | Zig Syntax | LLVM Lowering | Status |
|---|---------|-----------|-----------|------------|---------------|--------|
| 031 | Pointer type | `cir.ptr_type` | `*i32`, `*Point` | `*i32`, `*Point` | LLVM pointer type | - |
...
| # | Feature | CIR Op(s) | ac Syntax | Zig Syntax | LLVM Lowering | Status |
|---|---------|-----------|-----------|------------|---------------|--------|
| 049 | Enum declaration | `cir.enum_type` | `enum Color { Red, Green, Blue }` | `const Color = enum { red, green, blue };` | Integer type | - |
| 050 | Enum value | `cir.enum_literal` | `Color.Red` | `.red` or `Color.red` | Integer constant | - |
