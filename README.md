...
| Wasm Backend | ✅ M1-M11 Done | Constants, arithmetic, control flow, loops, function calls, CLI, memory, pointers |
| Wasm Backend | 🔄 M12 Next | Structs (layout, field access) |
...
**Tests: 382/404 passed, 22 skipped (native)**
