...
pub const Func = struct {
    ...
    pub fn numBlocks(self: *const Func) usize { return self.bid.next_id; } // Max ID, not count (matches Go)
    pub fn numValues(self: *const Func) ID { return self.vid.next_id; } // Max ID, not count (matches Go)
